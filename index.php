<?php 
include('conn.php');
$slider=mysql_query("select * from slider limit 8");
$teacher=mysql_query("select * from teacher  limit 4");
$service=mysql_query("select * from services limit 3");
$course=mysql_query("select * from courses limit 4");
...
<html lang="en">
  ...
  <section id="mu-slider">
    ...
    <?php while($sli=mysql_fetch_array($slider))
	{
	?>
    <div class="mu-slider-single">
      <div class="mu-slider-img">
        <figure>
          <span><img src="admin/upload/<?php echo $sli['slider_image'];?>" height="100" width="200"/></span>
        </figure>
      </div>
      <div class="mu-slider-content">
        <h4>Welcome To Varsity</h4>
        <span></span>
        <h2><?php echo $sli['slider_title'];?></h2>
        <p><?php echo $sli['slider_description'];?></p>
    ...
    <!--<div class="mu-slider-single">
      <div class="mu-slider-img">
        <figure>
         <span><img src="admin/upload/<?php echo $row['image'];?>" alt="img"></span>
        </figure>
      </div>
      <div class="mu-slider-content">
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12">
          <div class="mu-service-area">
            ...
            <?php while($as=mysql_fetch_array($service)) {
			?>
            <div class="mu-service-single">
              
              <span><img src="admin/upload/<?php echo $as['services_image'];?>" height="200" width="200" /></span>

              <h3><?php  echo $as['services_title'];?></h3>
              <p><?php echo $as['services_description'];?></p>
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12">
          <div class="mu-latest-courses-area">
            ...
            <?php while($ag=mysql_fetch_array($course)) { ?>
            
            
              <div class="col-lg-4 col-md-4 col-xs-12">
                <div class="mu-latest-course-single">
                  <figure class="mu-latest-course-img">
                    <span><img src="admin/upload/<?php  echo $ag['course_image'];?>"></span>
        ...
        <div class="col-md-12">
          <div class="mu-our-teacher-area">
            ...
            <div class="mu-our-teacher-content">
              <div class="row">
              <?php  while($ax=mysql_fetch_array($teacher)) {
			  ...
			  ?>
               ...
               <center>
                     <span> <img src="admin/upload/<?php echo $ax['teacher_image'];?>" style="height:200px;width:200px"></span></center>
